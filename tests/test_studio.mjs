...
assert.match(inlineComparison, /<h4>最终提示词<\/h4>/);
assert.match(inlineComparison, /id="prompt-review-entry"/);
assert.match(inlineComparison, /id="final-prompt-text"/);
assert.match(inlineComparison, /data-action="confirm-inline-prompts"/);
assert.doesNotMatch(inlineComparison, /对比共用提示词|data-action="edit-reviewed-prompt"/);
assert.doesNotMatch(inlineComparison, /<details/);
assert.match(inlineComparison, /TENT-2P-014/);
...
assert.ok(otherUi.indexOf('id="studio-other-requirements"') < otherUi.indexOf('小样模型对比'));
